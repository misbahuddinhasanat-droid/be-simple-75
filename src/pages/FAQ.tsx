    ...
    <div className="min-h-screen pb-20" style={{ background: "#050508", color: "#f5f6fa" }}>
      <div className="container px-4 md:px-8 pt-32 max-w-4xl">
        ...
        <div className="mt-20 p-12 rounded-[40px] text-center relative overflow-hidden" style={{ background: "rgba(255,23,68,0.03)", border: "1px solid rgba(255,23,68,0.1)" }}>
          ...
          <p className="text-slate-400 mb-8 max-w-md mx-auto text-sm">Our AI support agent is available 24/7, or you can message us directly on WhatsApp.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="btn-ai px-8 py-4 rounded-2xl text-xs font-black uppercase tracking-widest">Chat with AI</button>
            <button className="btn-ai-outline px-8 py-4 rounded-2xl text-xs font-black uppercase tracking-widest">WhatsApp Us</button>
          </div>
        </div>
      </div>
    </div>
