...
export default function Products() {
  ...
  return (
    <div style={{ background: "#05050f", minHeight: "100vh", color: "#f5f6fa" }}>
      {/* Header */}
      <div className="relative overflow-hidden" style={{ borderBottom: "1px solid rgba(168,85,247,0.12)" }}>
        <div className="absolute inset-0 pointer-events-none">
          ...
          />
          <div
            className="absolute top-0 right-1/3 w-64 h-64 rounded-full blur-3xl opacity-15"
            style={{ background: "radial-gradient(circle, #22d3ee 0%, transparent 70%)" }}
          />
        </div>

        <div className="container px-4 md:px-8 py-16 lg:py-20 relative z-10">
          <p className="text-[11px] font-black uppercase tracking-widest mb-3" style={{ color: "#a855f7" }}>✦ Full Collection</p>
      ...
      <div className="container px-4 md:px-8 py-12">
        {isLoading ? (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 flex translate-y-full group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
                    ...
                    <Link
                      ...
                      style={{ background: "rgba(0,0,0,0.75)", borderLeft: "1px solid rgba(168,85,247,0.2)" }}
                    >
                      View
                    </Link>
                  </div>
          ...
          <div
            ...
            style={{ border: "1px dashed rgba(168,85,247,0.2)", background: "rgba(168,85,247,0.02)" }}
          >
            ...
            <button
              ...
              className="btn-ai h-12 px-8 rounded-xl text-sm inline-flex items-center"
            >
